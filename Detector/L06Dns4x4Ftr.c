							     ...
							     const uint16* memPtrA )
{
	...
	memPtrA += bbs_memReadVersion32( &versionL, bbf_L06_DNS_4X4_FTR_VERSION, memPtrA );
	...
	if( memSizeL != bbf_L06Dns4x4Ftr_memSize( ptrA ) )
	{
		printf( "uint32 bbf_L06Dns4x4Ftr_memRead( struct bem_ScanGradientMove* ptrA, const uint16* memPtrA ):\n"
			        "size mismatch" );
		return 0;
	}
