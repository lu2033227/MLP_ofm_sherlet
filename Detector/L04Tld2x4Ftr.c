...
void bbf_L04Tld2x4Ftr_init( struct bbf_L04Tld2x4Ftr* ptrA )
{
...
void bbf_L04Tld2x4Ftr_exit( struct bbf_L04Tld2x4Ftr* ptrA )
{
...
uint32 bbf_L04Tld2x4Ftr_memSize( const struct bbf_L04Tld2x4Ftr* ptrA )
{
...
uint32 bbf_L04Tld2x4Ftr_memRead( struct bbf_L04Tld2x4Ftr* ptrA, 
							     const uint16* memPtrA )
{
	uint32 memSizeL, versionL;
	
	memPtrA += bbs_memRead32( &memSizeL, memPtrA );
	memPtrA += bbs_memReadVersion32( &versionL, bbf_L04_TLD_2X4_FTR_VERSION, memPtrA );
	...
	if( memSizeL != bbf_L04Tld2x4Ftr_memSize( ptrA ) )
	{
		printf( "uint32 bbf_L04Tld2x4Ftr_memRead( struct bem_ScanGradientMove* ptrA, const uint16* memPtrA ):\n"
			        "size mismatch" );
		return 0;
	}
