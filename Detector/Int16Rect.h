...
void bts_Int16Rect_init( struct bts_Int16Rect* ptrA );

/** destroys rectangle */
void bts_Int16Rect_exit( struct bts_Int16Rect* ptrA );
...
uint32 bts_Int16Rect_memRead( struct bts_Int16Rect* ptrA, 
