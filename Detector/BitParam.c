...
void bbf_BitParam_init( struct bbf_BitParam* ptrA )
{
	ptrA->innerRadiusE = 0;
	ptrA->outerRadiusE = 0;
}
...
void bbf_BitParam_exit( struct bbf_BitParam* ptrA )
{
	ptrA->innerRadiusE = 0;
	ptrA->outerRadiusE = 0;
}
...
void bbf_BitParam_copy( struct bbf_BitParam* ptrA, 
...
flag bbf_BitParam_equal( const struct bbf_BitParam* ptrA, 
					     const struct bbf_BitParam* srcPtrA )
{
...
uint32 bbf_BitParam_memSize( const struct bbf_BitParam* ptrA )
{
	uint32 memSizeL = 0; 
